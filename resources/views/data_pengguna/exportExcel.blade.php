...
<table>
    ...
    <tr>
        ...
        <th style="font-weight:bold;text-align:center;background:#f4f4f4;border:1px solid #000000;">Name</th> <!-- kolom B -->
        ...
        <th style="font-weight:bold;text-align:center;background:#f4f4f4;border:1px solid #000000;">Tanggal Buat</th> <!-- kolom I -->
    </tr>
    </thead>
    <tbody>
    @php $no=1; @endphp
    ...
    @foreach($data as $dt)
        @php 
        $dbKategori=DB::table('dtPengguna')->select('*')->first();
        @endphp
       <tr>
        <td>{{$no++}}</td>

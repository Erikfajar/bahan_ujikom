...
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="pd-10 pd-sm-20 bg-gray-100">
                            <!-- FORM INPUT UPDATE PENGGUNA -->
                            <form action="{{ route('data_pengguna.update', $data->id) }}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    <div class="col-md-3">
                                                        <label class="form-label mg-b-0">Name <span
                                                ...
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    ...
                                                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                        <select class="form-control" name="namerole" id="">
                                                            <option value="{{ $data->namerole }}" selected>
                                                                {{ $data->namerole }}</option>
                                            ...
                                            <div class="row row-xs align-items-top mg-b-20">
                                                ...
                                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                    ...
                                                    <small>
                                                        <p class="text-muted">* File Extention .png/.jpg/.jpeg | size image
                                                            Max 2MB : (1125px x 792px) &nbsp;</p>
                                                    </small>
                                                    <img class="img-responsive" width="25%" height="50%"
                                                        src="@if ($data->img) {{ asset('') }}images/user/{{ $data->img }} @else {{ asset('') }}images/no-image.png @endif">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <button type="submit" class="float-right btn btn-primary pd-x-30 mg-e-5 mg-t-5">
                                    <i class='fa fa-save'></i> Simpan</button> <!-- BUTTON SUBMIT -->
                                <a href="{{ route('data_pengguna') }}" class="btn btn-secondary pd-x-30 mg-t-5">
                                    <i class='fa fa-chevron-left'></i> Kembali</a> <!-- BUTTON KEMBALI KE DATA PENGGUNA -->
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(function() {
            //formplugin
            $('.select2').select2(); // SCRIPT UNTUK MENJALANKAN SELECT
            $('#datepickerA,#datepickerB').datepicker({ // UNTUK MENGATUR DATE
                format: 'dd/mm/yyyy',
                autoclose: true,
                todayHighlight: true,
            });
